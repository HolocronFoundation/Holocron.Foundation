// This javascript file loads the text page from the library entirely using the Ethereum Blockchain.
// To actually load this or a similar javascript file, I reccomend compressing using zip, and then
// prepping the file using our vyper zip file utility, then uploading using our upload utility.
// To access, head to reincarnati.online, and load jszip.min.js using the address on that page,
// then executing un(YOUR_ADDRESS_HERE) to load your own file and execute it.
///////////////////////////////////////////////////////////////////////////////////////////////////

//First, user is prompted to enter a book ID. Current valid IDs are 1, 4, and 11.
var id = prompt('Please enter a book ID');

//Next, the body is given an ID as needed by the CSS
document.body.id = 'textBody';
//The body is defined by a string of HTML
...
//The CSS is loaded via javascript
loadCSS();
//The Javascript used on this page is loaded
loadJS();
//The start Javascript function is called after all other items are loaded
start();

function loadCSS(){
	//This function loads the CSS by creating a style element and appending it to the head of the page
...
function loadLibraryContractABI() {
	//This function loads the ABI for the library contract
...
function loadBookABI(){
	//This function loads the ABI for the book contract
...
function loadAuthorABI(){
	//This function loads the ABI for the author contract
...
function loadZipABI(){
	//This function loads the ABI for zipped texts
