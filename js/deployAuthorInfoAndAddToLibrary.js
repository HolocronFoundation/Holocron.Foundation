...
var _parentAddress = '0xdA0835F4Ea95231B1CED731Ecd7B691139D6B4F5';
...
var files = fs.readdirSync('F:/Vyper Files/Small Working Files/authors');
...
function prepFile(index){
	if (index != byteFiles.length){
		...
		fs.readFile('F:/Vyper Files/Small Working Files/authors/' + byteFiles[index], 'utf-8', function(err, data){
			entry.push(data.slice(0, data.length-1));
			fs.readFile('F:/Vyper Files/Small Working Files/authors/' + abiFiles[index], 'utf-8', function(err, data2){
